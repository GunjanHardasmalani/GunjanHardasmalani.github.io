...
class Header extends Component {
 componentDidMount(){
  if ($('.nav-menu').length) {
    ...
    $('#header').prepend('<button type="button" class="mobile-nav-toggle d-lg-none"><i class="icofont-navigation-menu"></i> <FontAwesomeIcon icon={faBars}></FontAwesomeIcon>  </button>');
    ...
    return (    
        <header id="header" className="header-tops">
          <div className="container">
            ...
            <h2>
              I'm a passionate <span>Software Developer</span> from Boston
            </h2>
